...
export default function CommandInput() {
  ...
  return (
    <div className="h-32 border-t border-[#333] bg-black flex flex-col justify-end px-6 pb-6 pt-2 flex-shrink-0">
      ...
      <div className="flex gap-4 text-[11px] text-gray-400 mb-3 px-2 font-medium">
        <button className="hover:text-white transition-colors flex items-center gap-1.5">
          <span className="text-gray-500 text-[8px]">●</span> /sequence
        </button>
        <button className="hover:text-white transition-colors flex items-center gap-1.5">
          <span className="text-gray-500 text-[8px]">●</span> /wireframe
        </button>
        <button className="hover:text-white transition-colors flex items-center gap-1.5">
          <span className="text-gray-500 text-[8px]">●</span> /refactor
        </button>
      </div>
      ...
      <div className="border border-[#555] flex items-stretch focus-within:border-white transition-colors bg-[#050505]">
        ...
        <input
          ...
          className="flex-1 bg-transparent border-none text-sm text-white placeholder:text-gray-500 px-4 py-4 focus:outline-none font-mono"
        />
        ...
        <div className="flex items-stretch border-l border-[#555]">
          <div className="flex flex-col justify-center px-4 text-right">
            ...
            <span className="text-[8px] text-gray-400 tracking-widest">READY</span>
          </div>
