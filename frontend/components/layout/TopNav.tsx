...
export default function TopNav() {
  return (
    <div className="h-12 border-b border-[#333] flex items-center justify-between px-6 bg-black flex-shrink-0">
      <div className="flex items-center gap-4">
        <Terminal size={16} className="text-gray-300" />
        <span className="text-xs font-bold tracking-widest text-white uppercase">
          Command_Center
        </span>
        <span className="text-[10px] text-gray-400">V4.0.1</span>
      </div>

      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 bg-white rounded-full animate-pulse shadow-[0_0_8px_rgba(255,255,255,0.8)]"></div>
          <span className="text-[10px] text-gray-300 tracking-widest uppercase font-bold">System Ready</span>
        </div>
